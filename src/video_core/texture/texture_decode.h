 ...
 */
const Math::Vec4<u8> LookupTexture(const u8* source, unsigned int x, unsigned int y,
                                   const TextureInfo& info, bool disable_alpha = false);

const Math::Vec4<u8> LookupTexelInTile(const u8* source, unsigned int x, unsigned int y,
